...
public class StudentManagement extends Person {
	...
	public void write(Student[] student) { 
        ...
        try {   
            FileOutputStream fo = new FileOutputStream("D:\\student.dat");   // tao file f tro den student.dat
    ...
    public Student[] read() {
        ...
        try {   
            FileInputStream fi = new FileInputStream("D:\\student.dat"); // tao file f tro den student.dat
